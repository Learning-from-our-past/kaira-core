...
def setup_extraction_framework_for_bookseries(
    bookseries_id, plugin_directory, update_callback
):
    available_bookseries = {
        x['book_series_id']: x
        for x in find_available_bookseries_from_directory(plugin_directory)
    }
