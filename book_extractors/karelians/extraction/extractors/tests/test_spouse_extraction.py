...
pipeline:
  - !Extractor {
      ...
      pipeline: [
        ...
        !Extractor {
          module: "book_extractors.karelians.extraction.extractors.death_extractor",
        ...
        !Extractor {
          module: "book_extractors.karelians.extraction.extractors.wedding_extractor",
        ...
        !Extractor {
          module: "book_extractors.karelians.extraction.extractors.martta_activity_flag_extractor",
