import pytest
from book_extractors.karelians.extractors.child_extractor import ChildExtractor
from book_extractors.karelians.extractors.tests.children.mock_person_data import CHILDREN_TEXTS, EXPECTED
...
class TestChildrenExtraction:
    ...
    def should_fill_birth_place_data_correctly_when_each_kid_has_different_birth_place(self, child_extractor, th):
        result, metadata = child_extractor.extract({'text': CHILDREN_TEXTS['different_birth_places']}, {}, {})
