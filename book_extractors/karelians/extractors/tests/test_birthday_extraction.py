import pytest
from book_extractors.karelians.extractors.location_extractor import BirthdayLocationExtractor
from book_extractors.karelians.extractors.birthday_extractor import BirthdayExtractor
