...
class OwnerExtractor(BaseExtractor):
    ...
    def _find_owner(self, text, start_position):
        ...
        cursor_location = max(owner_year_result[1], owner_name_details_result[1], owner_birthday_result[1])
        result = {
            ...
            KEYS["ownerBirthData"]: owner_birthday_result[0]
        }
    ...
    def _find_owner_birthday(self, text):
        ...
        final_cursor_location = max(results['cursor_locations'].values())
