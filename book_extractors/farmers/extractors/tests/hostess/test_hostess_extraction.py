import pytest
from book_extractors.farmers.extractors.tests.hostess.mock_person_data import HOSTESS_TEXTS, EXPECTED
...
pipeline:
  - !Extractor {
      module: "book_extractors.farmers.extractors.hostess_extractor",
      class_name: "HostessExtractor",
      pipeline: [
        !Extractor {
            module: "book_extractors.farmers.extractors.birthday_extractor",
