import pytest
from book_extractors.farmers.extractors.child_extractor import ChildExtractor
from book_extractors.farmers.extractors.tests.children.mock_person_data import EXPECTED_CHILDREN, CHILDREN_TEXTS
