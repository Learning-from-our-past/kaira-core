...
from shared.textUtils import remove_spaces_from_text
...
class TestTextUtils:
    ...
    def should_correctly_return_text_without_hyphens(self):
        expected_text = 'Throughout history, humans have been interacting with the biosphere via pulses. '\
        ...
        hyphenated_text = 'Throug-hout history, hu⸗mans have been int－eracting with the bios⸗phere via pulses. '\
    ...
    def should_correctly_return_text_without_spaces(self):
        expected_text = 'Throughouthistory,humanshavebeeninteractingwiththebiosphereviapulses.'\
        ...
        spaced_text = 'Thr oug ho ut hi st　ory, h uma ns have be　en interac ting with the biosph ere via pu lses. ' \
