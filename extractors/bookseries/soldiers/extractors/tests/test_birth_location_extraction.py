...
from extractors.bookseries.soldiers.extractors.birthlocation_extractor import BirthLocationExtractor
...
class TestSoldierBirthLocationExtraction:
    ...
    def should_extract_location_with_coordinates(self, location_extractor):
        ...
        results, metadata = location_extractor.extract({'text': text}, {}, previous_metadata)
        ...
        assert metadata['birthLocation']['cursorLocation'] == 32  # Match ends at position 32 after "Paimio,"
