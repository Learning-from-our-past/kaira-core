...
class TestSoldiersHtmlChunking:
    ...
    def should_correctly_chunk_typical_html_into_xml_person_entries(self, person_preprocessor):
        persons = person_preprocessor.chunk_text(mock_html_data.TWO_PEOPLE, 'rintamamiehet', 1)
    ...
    def should_correctly_identify_page_number_and_tag_person_entries_with_it(self, person_preprocessor):
        persons = person_preprocessor.chunk_text(mock_html_data.ENTRIES_ACROSS_PAGES, 'rintamamiehet', 1)
