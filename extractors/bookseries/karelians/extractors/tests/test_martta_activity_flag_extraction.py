import pytest
from extractors.bookseries.karelians.extractors.martta_activity_flag_extractor import (
    MarttaActivityFlagExtractor,
)
...
class TestMarttaActivityFlagExtraction:
    ...
    def _verify_flags(
        ...
        extractor = MarttaActivityFlagExtractor(
    ...
    def should_return_true_if_text_contains_mentions_of_participating_in_martta_org_and_primaryperson_is_female_and_extractor_not_in_spouse_extractor(
        self, result_map
    ):
        self._verify_flags(
            [
    ...
    def should_return_true_if_text_contains_mentions_of_participating_in_martta_org_with_typos_and_spaces_and_hyphens_and_primaryperson_is_female_and_extractor_not_in_spouse_extractor(
        self, result_map
    ):
        self._verify_flags(
            [
    ...
    def should_return_true_if_primaryperson_is_male_and_extractor_is_in_spouse_extractor(
        self, result_map
    ):
        self._verify_flags(
    ...
    def should_return_false_if_text_contains_Martta_as_name_primaryperson_is_female_and_extractor_is_not_in_spouse_extractor(
        self, result_map
    ):
        self._verify_flags(
    ...
    def should_return_false_if_text_contains_no_mention_of_marttaism_and_primaryperson_is_female_and_extractor_is_not_in_spouse_extractor(
        self, result_map
    ):
        self._verify_flags(
    ...
    def should_return_none_if_primaryperson_is_male_and_extractor_not_in_spouse_extractor(
        self, result_map
    ):
        self._verify_flags(
    ...
    def should_return_none_if_primaryperson_is_female_and_extractor_is_in_spouse_extractor(
        self, result_map
    ):
        self._verify_flags(
            [('Rouva kuului Marttayhdistykseen.', None)],
