...
class TestMilitaryRankExtraction:
    ...
    def should_extract_the_highest_rank_in_the_entry_if_a_promotion_is_mentioned(
        self, result_map
    ):
        data = (
            'Testiläinen oli vääpeli talvisodassa ja palveliRaskaassa tykistössä. '
    ...
    def should_not_extract_merikapteeni_as_kapteeni(self, result_map):
        data = (
            'Testikäs on käynyt Viipurin merenkulkukoulun, Raumalla '
    ...
    def should_extract_none_if_primary_person_is_male_and_we_are_in_spouse_extractor(
        self, result_map
    ):
        self._verify_rank(
            result_map,
            'Testikäs palveli kommodorina talvisodassa.',
            None,
            sex='Male',
            in_spouse=True,
        )

    def should_extract_rank_if_primary_person_is_female_and_we_are_in_spouse_extractor(
        self, result_map
    ):
        self._verify_rank(
            result_map,
    ...
    def should_extract_none_if_primary_person_is_female_and_we_are_not_in_spouse_extractor(
        self, result_map
    ):
        self._verify_rank(
            result_map,
