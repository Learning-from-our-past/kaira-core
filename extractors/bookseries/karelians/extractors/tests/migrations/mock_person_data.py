...
LOCATION_TEXTS_WITH_ROUVA_WORD = [
    ...
    # Here extraction doesn't stop correctly to last entry but instead includes Rouva and all other stuff after it.
    {
        ...
        'expected': [
            ...
            {'locationName': 'Vaasa', 'movedIn': 44, 'movedOut': 46, 'region': 'other'},
            {
                'locationName': 'Turku',
                'movedIn': 46,
                'movedOut': None,
    ...
    # Here extraction doesn't stop correctly and instead includes persons name Saima interpreted as Saimaa and then later word Rouva.
    {
        ...
        'expected': [
            ...
            {'locationName': 'Koski', 'movedIn': 44, 'movedOut': 45, 'region': 'other'},
            {
                'locationName': 'Miehikkälä',
                'movedIn': 45,
                'movedOut': 47,
...
LOCATION_HEURISTICS = {
    ...
    'short_place_name': {
        ...
        'expected': [
            ...
            {
                'movedOut': None,
                'village': {'locationName': 'Hankavesi'},
                'movedIn': 41,
                'region': 'other',
                'locationName': 'Ähtäri',
            },
        ...
        'expected': [
            {
                ...
                'locationName': 'Kankaanpää',
                'movedIn': 39,
                'village': {'locationName': 'Lauhalankoulu'},
                'movedOut': 40,
            },
            {
                'region': 'other',
