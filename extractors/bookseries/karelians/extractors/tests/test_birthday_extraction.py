import pytest
from extractors.bookseries.karelians.extractors.location_extractor import BirthdayLocationExtractor
from extractors.bookseries.karelians.extractors.birthday_extractor import BirthdayExtractor
...
class TestBirthDayExtractor:
    ...
    def mock_entries(self):
        return [
            {'text': 'maanviljelijä, synt. 22. 9. -09Hiitolassa. Puol. Vaimo Vaimoikas o.s.', 'result': '2291909'},
            {'text': 'Testikäinen, emäntä, synt. 30. 8. -21 Hiitolassa. Avioit. -44. Poika: ', 'result': '3081921'},
            {'text': 'o.s. Testinen, rouva, synt. 29. 9. -18 Hiitolassa. Puol. ', 'result': '2991918'},
            {'text': 'Testimies, ahtaaja, synt. 12. 2.    16Ahlaisissa. Avioit. -44. Lapset: ', 'result': '1221916'},
            {'text': 'o.s. Testeri, vanhaemäntä. synt. 14, 3. -84 Kuolemajärvellä. Puol. ', 'result': '1431884'},
            {'text': 'Testaaja, synt. Muurilassa. Kuoli. -41 Urjalassa Lapset:', 'result': 'NoneNoneNone'},
            {'text': 'o.s. Laadunvalvoja. ent. Koodari, emäntä, synt. 1. 2. -92 Uudellakirkolla. Puol. ', 'result': '121892'},
    ...
    def should_extract_dates_correctly(self,  mock_entries, th):
        ...
        for test_text in mock_entries:
            ...
            assert '{}{}{}'.format(result['birthData']['birthDay'],
                                   result['birthData']['birthMonth'],
                                   result['birthData']['birthYear']) == test_text['result']
