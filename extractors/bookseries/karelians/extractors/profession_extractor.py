...
class ProfessionExtractor(BaseExtractor):
    ...
    def __init__(self, cursor_location_depends_on=None, options=None):
        ...
        with open(
            'support_datasheets/occupations.csv', 'r', encoding='utf-8'
        ) as occupations_list:
            ...
            for occupation in occupations:
                self._occupation_extra_data[occupation['professionName']] = {
                    ...
                    'agricultureOrForestryRelated': bool(
                        occupation['agricultureOrForestryRelated']
                    ),
    ...
    def _add_profession_extra_information(self, profession_name):
        profession_output = {'professionName': profession_name, 'extraInfo': None}

        if profession_name in self._occupation_extra_data:
            profession_output['extraInfo'] = self._occupation_extra_data[
                profession_name
            ]
