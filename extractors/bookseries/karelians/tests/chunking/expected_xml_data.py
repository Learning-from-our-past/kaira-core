...
TWO_PEOPLE = XML_CONTAINER.format(
    """  <PERSON name="NYYMINEN, IHMINEN" approximated_page="0-2">
...
MILITARY_UNIT_IN_ENTRY = XML_CONTAINER.format(
    """  <PERSON name="PIMEÄ, RUHTINAS MATTI" approximated_page="0-2">
...
MID_ENTRY_PEOPLE = XML_CONTAINER.format(
    """  <PERSON name="NYYMI. NYYMI" approximated_page="0-2">
...
ENTRIES_ACROSS_PAGES = XML_CONTAINER.format(
    """  <PERSON name="NIMETÖN, MANIMETÖN MENIMETÖN" approximated_page="0-2">
