...
pipeline:
  - !Extractor {
      module: "extractors.greatfarmers.extractors.spouse_extractor",
      class_name: "SpouseExtractor",
      pipeline: [
        !Extractor {
            module: "extractors.greatfarmers.extractors.birthday_extractor",
            class_name: "BirthdayExtractor"
        },
        !Extractor {
            module: "extractors.greatfarmers.extractors.original_family_extractor",
