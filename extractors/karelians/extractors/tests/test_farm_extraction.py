import pytest
from extractors.karelians.extractors.farm_area_extractor import FarmAreaExtractor
...
pipeline:
  - !Extractor {
      module: "extractors.karelians.extractors.farm_extractor",
      ...
      pipeline: [
        ...
        !Extractor {
          module: "extractors.karelians.extractors.farm_area_extractor",
