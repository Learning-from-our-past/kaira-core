...
pipeline:
  - !Extractor {
      module: "extractors.karelians.extractors.spouse_extractor",
      class_name: "SpouseExtractor",
      pipeline: [
        !Extractor &SpouseFormerSurname {
          module: "extractors.karelians.extractors.original_family_extractor",
        ...
        !Extractor {
          module: "extractors.karelians.extractors.profession_extractor",
        ...
        !Extractor &SpouseBirthday {
          module: "extractors.karelians.extractors.birthday_extractor",
        ...
        !Extractor &SpouseBirthLocation {
          module: "extractors.karelians.extractors.location_extractor",
        ...
        !Extractor {
          module: "extractors.karelians.extractors.death_extractor",
        ...
        !Extractor {
          module: "extractors.karelians.extractors.wedding_extractor",
        ...
        !Extractor {
          module: "extractors.karelians.extractors.martta_activity_flag_extractor",
        ...
        !Extractor {
          module: "extractors.karelians.extractors.war_data_extractor",
          ...
          pipeline: [
            !Extractor {
              module: "extractors.karelians.extractors.injured_in_war_flag_extractor",
            ...
            !Extractor {
              module: "extractors.karelians.extractors.served_during_war_flag_extractor",
            ...
            !Extractor {
              module: "extractors.karelians.extractors.lotta_activity_flag_extractor",
