import pytest
from extractors.karelians.extractors.location_extractor import BirthdayLocationExtractor
from extractors.karelians.extractors.birthday_extractor import BirthdayExtractor
