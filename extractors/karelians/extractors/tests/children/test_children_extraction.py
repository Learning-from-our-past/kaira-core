import pytest
from extractors.karelians.extractors.child_extractor import ChildExtractor
from extractors.karelians.extractors.tests.children.mock_person_data import CHILDREN_TEXTS, EXPECTED
