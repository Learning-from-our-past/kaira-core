import pytest
from extractors.farmers.extractors.tests.hostess.mock_person_data import HOSTESS_TEXTS, EXPECTED
...
pipeline:
  - !Extractor {
      module: "extractors.farmers.extractors.hostess_extractor",
      class_name: "HostessExtractor",
      pipeline: [
        !Extractor {
            module: "extractors.farmers.extractors.birthday_extractor",
