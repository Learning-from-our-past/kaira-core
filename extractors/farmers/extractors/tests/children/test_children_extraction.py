import pytest
from extractors.farmers.extractors.child_extractor import ChildExtractor
from extractors.farmers.extractors.tests.children.mock_person_data import EXPECTED_CHILDREN, CHILDREN_TEXTS
